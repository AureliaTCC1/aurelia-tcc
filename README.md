...
| --- | --- | --- |
| App do cuidador | `caregiver` | Thiago Mattos |
| App do idoso | `idoso_app` | Pyetro Fabricio |
...
```bash
git clone https://github.com/<usuario>/aurelia-tcc.git
cd aurelia-tcc
...
| Landing page | HTML5, CSS, JavaScript |
